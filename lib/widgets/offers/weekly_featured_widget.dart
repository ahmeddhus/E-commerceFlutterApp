...
class WeeklyFeaturedWidget extends StatefulWidget {
  @override
  _WeeklyFeaturedWidgetState createState() => _WeeklyFeaturedWidgetState();
}

class _WeeklyFeaturedWidgetState extends State<WeeklyFeaturedWidget> {
